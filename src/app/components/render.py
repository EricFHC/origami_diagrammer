...
# folded_state_style = StyleManager()
# folded_state_style.configure(
#     "vertex.TOval",
#     width=(2, 2, 4, 4),
#     outline=("black", "#f19ade", "#b22df0", "#664C71"),
#     fill=("black", "#f19ade", "#b22df0", "#664C71")
# )
# folded_state_style.configure(
#     "edge.TLine",
#     width=(4, 4, 4, 4),
...
# folded_state_style.configure(
#     "white.face.TPoly",
#     fill=("white", "#f19ade", "#b22df0", "#664C71")
# )
# folded_state_style.configure(
#     "colored.face.TPoly",
#     fill=("#d1d1c9", "#f19ade", "#b22df0", "#664C71")
# )

# unfold_state_style = StyleManager()
# unfold_state_style.configure(
#     "vertex.TOval",
#     width=(0, 2, 2, 4),
#     outline=("", "", "", ""),
#     fill=("", "#f19ade", "#b22df0", "#664C71")
# )
# unfold_state_style.configure(
#     "crease.TLine",
#     width=(1, 1, 1, 1),
#     fill=("#d1d1c9", "#d1d1c9", "#d1d1c9", "#d1d1c9"),
#     dash=("", "-", "-", "-")
# )
# unfold_state_style.configure(
#     "mountain.crease.TLine",
#     width=(2, 2, 2, 2),
